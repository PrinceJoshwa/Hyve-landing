...
<section className="bg-[#F4F7FE] py-20 px-4 sm:px-8">
  <div className="max-w-7xl mx-auto">
    {/* Section Heading */}
    <div className="text-center mb-14">
      <span className="inline-block px-4 py-1 bg-yellow-100 text-yellow-800 rounded-full text-xs font-semibold uppercase tracking-wide mb-4">
        What's Next?
      </span>
      <h2 className="text-4xl font-extrabold text-gray-900 mb-4">Coming Soon 🚀</h2>
      <p className="text-lg text-gray-600 max-w-2xl mx-auto">
        We’re building the future of freelancing. Here’s a sneak peek of upcoming features on HYVE.
      </p>
    </div>

    {/* Feature Timeline Layout */}
      ...
      {[
        {
          ...
          desc: 'Smart algorithms to find the perfect freelancer-project fit.',
          bg: 'bg-yellow-50',
        },
        {
          icon: <Briefcase className="w-6 h-6 text-yellow-500" />,
          title: 'Portfolio Builder Tools',
          desc: 'Create professional portfolios with customizable templates.',
          bg: 'bg-yellow-50',
        },
        {
          icon: <GraduationCap className="w-6 h-6 text-green-600" />,
          title: 'Skill Resources & Certification',
          desc: 'Upskill with curated content and earn verified badges.',
          bg: 'bg-green-50',
        },
        {
          icon: <Crown className="w-6 h-6 text-purple-600" />,
          title: 'Premium Freelancer Subscriptions',
          desc: 'Get exclusive perks and early access to opportunities.',
          bg: 'bg-purple-50',
        },
        {
          icon: <Building className="w-6 h-6 text-red-600" />,
          title: 'Team to Agency Conversions',
          desc: 'Turn your team into a full-fledged freelance agency.',
          bg: 'bg-red-50',
        },
      ].map((item, idx) => (
        <div
          key={idx}
          className="relative bg-white border border-gray-100 shadow-md rounded-2xl p-6 hover:shadow-xl transition-all duration-300 group"
        >
          ...
          <span className="absolute top-4 right-4 bg-yellow-500 text-white text-[10px] px-2 py-0.5 rounded-full">
            Coming Soon
          </span>
        </div>
      ))}
    ...
    <div className="text-center mt-14">
      <Link href="https://staging.hyvefreelance.com/auth/login" passHref>
        <Button
          className="bg-yellow-400 hover:bg-yellow-500 text-black px-6 py-3 rounded-full text-base font-semibold transition-all"
          asChild
        >
