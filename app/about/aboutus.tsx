...
export default function AboutUsPage() {
  return (
    <main className="bg-[#f8fafc] relative text-[#2D2D2D] overflow-hidden min-h-screen">
      <div
    ...
    `,
      ...
      <div className="relative z-10 py-16 lg:py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center text-[#2D2D2D] mb-16 lg:mb-24">
            <span className="inline-flex items-center px-4 py-2 rounded-full bg-[#FFF4D6] text-[#F1AB13] text-sm font-medium mb-6">
              <MapPin className="w-4 h-4 mr-2" /> IN Born in India, Built for
              India
            </span>
            <h1 className="text-5xl sm:text-4xl lg:text-6xl font-extrabold mb-6 leading-tight">
              Born from the{" "}
            ...
            <p className="text-lg sm:text-xl lg:text-2xl leading-relaxed max-w-4xl mx-auto text-gray-700">
              Built by freelancers who understand Indian challenges, HYVE aims
              to empower freelancers to work collaboratively and grow
              sustainably in the digital economy.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
            ...
            <div className="space-y-8">
              {/* Our Story Card */}
              <Card className="bg-white rounded-3xl hover:shadow-[4px_4px_0_1px_#F1AB13] transition-shadow duration-200 p-8 border border-gray-100 group">
                <CardContent className="p-0">
                  <div className="flex items-center mb-4">
                    <Heart className="w-8 h-8 text-red-500 mr-3 group-hover:w-12 group-hover:h-12 transition-all duration-200" />{" "}
                    {/* Keeping red for heart as per image */}
                    <h2 className="text-3xl group-hover:text-4xl transition-all duration-200 font-bold text-[#2D2D2D]">
                      Our Story
                    </h2>
                  </div>
                  <p className="text-lg text-gray-700 leading-relaxed">
                    HYVE was born out of every freelancer’s 3 AM frustration:
                    payment delays, working alone, and hustling for inconsistent
                    gigs. We saw talented Indian designers, developers, and
                    writers stuck in a cycle of working in isolation, chasing
                    clients, and facing the uncertainty of "will I get paid on
                    time?"
                    <br />
                    <br />
                    We believed freelancing in India shouldn’t feel like a
                    lonely fight.
                    <br />
                    <br />
                    So we built HYVE — a place where{" "}
                    <span className="font-semibold">
                      freelancers don’t just find gigs, they find teams,
                      stability, and a path to truly grow.
                    </span>
                  </p>
                </CardContent>
              </Card>
              ...
              {/* Three Feature Sections */}
              <div className="space-y-6">
                <div className="flex items-start p-6 bg-orange-50 rounded-2xl shadow-sm group hover:shadow-[4px_4px_0_1px_#d68583] transition-shadow duration-200">
                  <div className="w-12 h-12 flex items-center justify-center bg-orange-100 rounded-full mr-4 flex-shrink-0 group-hover:scale-125 transition-all duration-200">
                  ...
                  <div>
                    ...
                    <p className="text-base text-gray-700">
                      We believe freelancers achieve more when they work
                      together, not against each other.
                    </p>
                  </div>
                </div>
                <div className="flex items-start p-6 bg-purple-50 rounded-2xl shadow-sm group hover:shadow-[4px_4px_0_1px_#9810fa] transition-shadow duration-200">
                  <div className="w-12 h-12 flex items-center justify-center bg-purple-100 rounded-full mr-4 flex-shrink-0 group-hover:scale-125 transition-all duration-200">
                  ...
                  <div>
                    ...
                    <p className="text-base text-gray-700">
                      Every interaction on HYVE is built on trust, fair pricing,
                      and clear communication.
                    </p>
                  </div>
                </div>
                <div className="flex items-start p-6 bg-green-50 rounded-2xl shadow-sm group hover:shadow-[4px_4px_0_1px_#00a63e] transition-shadow duration-200">
                  <div className="w-12 h-12 flex items-center justify-center bg-green-100 rounded-full mr-4 flex-shrink-0 group-hover:scale-125 transition-all duration-200">
                  ...
                  <div>
                    ...
                    <p className="text-base text-gray-700">
                      We're committed to helping every freelancer and startup
            ...
            {/* Right Column: Mission & Vision Card */}
            <Card className="lg:min-h-[750px] md:h-fit overflow-hidden bg-gradient-to-br from-[#F1AB13] to-[#F97416] rounded-3xl shadow-xl p-6 sm:p-8 text-white flex flex-col w-full max-w-4xl mx-auto hover:shadow-xl transition-all duration-300 transform hover:-translate-y-4">
              <CardContent className="p-0 space-y-10">
                {/* Our Mission Section */}
                <div>
                  <div className="flex items-center mb-4">
                  ...
                  <p className="text-lg text-white/90 leading-relaxed">
                    "To empower Indian freelancers and startups to{" "}
                    <span className="font-semibold">grow together</span>.
                    <br />
                    <br />
                    HYVE is building a space where freelancers can find
                    consistent work, form teams, and level up — not just chase
                    gigs alone. For startups, we make it easy to access{" "}
                    <span className="font-semibold">
                      affordable, high-quality talent without the hiring
                      headache
                    </span>
                    .
                    <br />
                    <br />
                    Unlike foreign platforms that miss India’s realities, HYVE
                    is designed for{" "}
                    <span className="font-semibold">
                      Indian freelancers, Indian pricing, and Indian ambition
                    </span>
                    ."
                  </p>
                </div>
                ...
                {/* Our Vision Section */}
                <div className="backdrop-blur-md bg-white/20 rounded-3xl p-6 sm:p-8 mt-5">
                  <div className="flex items-center mb-4">
                    <Rocket className="w-8 h-8 text-white mr-3" />
                    <h2 className="text-3xl font-bold">Our Vision</h2>
                  </div>
                  <p className="text-lg text-white/90 leading-relaxed">
                    We envision a future where freelancers <span className="font-semibold">thrive together, not
                    alone</span>— where teams form naturally, projects flow
                    seamlessly, and success is shared by all.
                    <br/>
                    <br />
                    A future where
                    Indian talent is valued, where payments are secured, and
                    where freelancers can focus on building their craft, not
                    just their next invoice.
                  </p>
                </div>
              </CardContent>
            </Card>
          ...
          {/* Quote Section */}
          <div className="mt-20 lg:mt-28 bg-[#FFF4D6] rounded-3xl p-8 sm:p-12 text-center shadow-lg">
            <MessageSquareText className="w-12 h-12 text-[#F1AB13] mx-auto mb-0" />
            <p className="text-2xl sm:text-3xl font-bold text-[#2D2D2D] leading-relaxed mb-4">
              {
                '"By Freelancers, For Freelancers — HYVE is built by those who\'ve lived the hustle."'
              }
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              Every feature, every decision, every line of code comes from real
              freelancing experience. We're not just building a platform; we're
...
const ImpactContent = () => (
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-left">
    {[
      ...
      >
        <CardContent className="p-0">
          <strong className="block text-[#2D2D2D] text-xl font-bold mb-2">
            {item.title}
          </strong>
