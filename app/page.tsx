    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <main className="relative overflow-hidden">
        ...
        <div className="relative flex justify-center items-center min-h-[400px] sm:min-h-[500px] px-4 sm:px-6">
          ...
          {/* Ved Sharma Card - Top Left */}
          <div className="absolute top-4 left-[15%] w-40 sm:w-52">
            <Image
              src="/ved-sharma-card.png"
              alt="Ved Sharma - Front End Developer"
              width={208}
          ...
          {/* Jiya Gupta Card - Top Right */}
          <div className="absolute top-4 right-[15%] w-40 sm:w-52">
            <Image
              src="/jiya-gupta-card.png"
              alt="Jiya Gupta - Graphic Designer"
              width={208}
          ...
          <div className="relative z-10">
            <Image
              ...
              width={320}
              height={320}
              className="w-[400px] h-[400px] sm:w-[600px] sm:h-[600px] object-contain"
            />
          </div>

          {/* Rahul Shetty Card - Bottom Left */}
          <div className="absolute top-36 left-[22%] w-40 sm:w-52">
            <Image
              src="/rahul-shetty-card.png"
              alt="Rahul Shetty - UI/UX Designer"
              width={208}
          ...
          {/* Total Earnings Card - Right */}
          <div className="absolute top-1/4 right-[20%] w-48 sm:w-60">
            <Image
              src="/earnings-card.png"
              alt="Total Earnings ₹3,00,000"
              width={240}
          ...
          {/* Escrow Payment Card - Bottom Left */}
          <div className="absolute bottom-16 left-[20%] w-44 sm:w-56">
            <Image
              src="/escrow-payment-card.png"
              alt="Escrow Payment - Safe & Secured Protection"
              width={224}
          ...
          {/* Form a Team / Create TEAM buttons with dotted lines */}
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col space-y-2 sm:space-y-3 z-20">
          ...
          {/* New Task Alert - Bottom Right */}
          <div className="absolute bottom-4 right-[20%] w-40 sm:w-52">
            <Image
              src="/new-task-alert.png"
              alt="New Task Alert - Build website for D2C brand ₹30,000"
              width={208}
        ...
        <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50">
          <Button className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-green-500 hover:bg-green-600 text-white shadow-lg">
